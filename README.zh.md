...
**cldev** 是一个用于管理 Claude Code 开发工作流的统一 CLI 工具。它将 33 个重要的开发命令整合到单个类型安全、超快速的 Rust 二进制文件中，并完全支持国际化（英语/日语/中文）。
...
- **统一**：9 个类别 33 个命令集成到单一工具（config、dev、git、quality、tech、ops、analysis、learning、todo）
